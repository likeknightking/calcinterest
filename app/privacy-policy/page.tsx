...
export const metadata: Metadata = {
  title: 'Privacy Policy — CalcInterest.com',
  description: 'Privacy policy for CalcInterest.com. Learn how we handle your data, our use of cookies, Google AdSense, and Google Analytics.',
  alternates: { canonical: 'https://calcinterest.com/privacy-policy' },
}
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-600 leading-relaxed">
          <section>
            ...
            <p>CalcInterest.com (&quot;we,&quot; &quot;our,&quot; or &quot;the site&quot;) provides free online compound interest and investment calculators. We are committed to protecting your privacy. This policy explains what data is collected when you use our site and how it is used.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-slate-800 mt-8 mb-3">Data We Collect</h2>
            <p>Our calculators run entirely in your browser. All principal amounts, interest rates, time periods, and contribution values you enter are processed client-side using JavaScript. No calculation data is transmitted to our servers or any third party. We do not require registration, and we do not collect personal information such as your name, email address, or phone number.</p>
          </section>
          ...
          <section>
            ...
            <p>If you have any questions about this privacy policy, please contact us at <strong>contact@calcinterest.com</strong>.</p>
          </section>
        </div>
      </main>
